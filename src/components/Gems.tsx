  ...
  return (
    <span className="amlogo" style={{ width: size, height: size }} aria-hidden>
      <svg viewBox="0 0 16 16" role="img" focusable="false">
        ...
        <path className="gem-edge-dark" d="M7 1h2v1h2v2h2v2h2v4h-2v2h-2v2H9v1H7v-1H5v-2H3v-2H1V6h2V4h2V2h2z" />
        ...
        <path className="gem-deep" d="M10 5h2v2h2v3h-2v2h-2v2H9v-4h1z" />
